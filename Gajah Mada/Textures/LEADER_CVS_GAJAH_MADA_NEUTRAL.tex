...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Gajah Mada\Texture_Source\LEADER_CVS_GAJAH_MADA_NEUTRAL.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3566198393</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_CVS_GAJAH_MADA_NEUTRAL.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_CVS_GAJAH_MADA_NEUTRAL"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
