...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Gajah Mada\Texture_Source\male_caucasain_t_retintable.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4049300165</m_ExportedTime>
	<m_ClassName text="Generic_TintMask"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="male_caucasain_t_retintable.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="male_caucasain_t_retintable"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
