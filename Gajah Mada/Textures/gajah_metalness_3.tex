...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Gajah Mada\Texture_Source\gajah_metalness_3.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1016845587</m_ExportedTime>
	<m_ClassName text="Leader_Metalness"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="gajah_metalness_3.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="gajah_metalness_3"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
