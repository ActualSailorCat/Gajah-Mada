...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ5Mod\Leaderhead_Work\HQ_Textures\gajah_accessories_norm.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1957913468</m_ExportedTime>
	<m_ClassName text="Leader_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="gajah_accessories_norm.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="gajah_accessories_norm"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
