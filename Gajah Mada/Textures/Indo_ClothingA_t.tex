...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Gajah Mada\Texture_Source\Indo_ClothingA_t.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>380503955</m_ExportedTime>
	<m_ClassName text="Generic_TintMask"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Indo_ClothingA_t.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Indo_ClothingA_t"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
