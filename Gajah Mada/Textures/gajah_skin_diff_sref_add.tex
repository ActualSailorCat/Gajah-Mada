...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ5Mod\Leaderhead_Work\HQ_Textures\gajah_skin_diff_sref_add.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1915606645</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="gajah_skin_diff_sref_add.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="gajah_skin_diff_sref_add"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
